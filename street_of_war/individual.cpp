...
void individual::nivel1()
{
    ...
    if(auxpelea==4){
        if((jug2->getPosx())-(jug1->getPosx())>236){
            ...
            if((jug2->getPosx())-(jug1->getPosx())<130){
                if(aux==0){
                    patada2=1;
                }
                if(aux==2){
...
void individual::anim()
{
    ...
    if(vida1<=0){
        ...
        ui->graphicsView->setBackgroundBrush(QBrush(QImage(":/nivel1.1.jpg")));
    ...
    if(vida2<=0){
        ...
        button->setGeometry(450,200,300,80);
        button2->setGeometry(450,350,300,80);
        connect(button,SIGNAL(clicked(bool)),this,SLOT(opcion3()));
        connect(button2,SIGNAL(clicked(bool)),this,SLOT(opcion2()));
    }
